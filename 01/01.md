...
- 我以前一直以为得要达到 `xxx` 水平才能去做某件事，现在想来，这是很可笑的一件事 -> 你从不会到会才能提高水平呀！可你不去做「不会的」怎么才能提高水平呢？ -> 动手吧！骚年！把这个东西干掉，当然，在干掉它的途中，你会学会使用各种武器，甚至会制造一些独门的武器！ -> 所谓的前置知识，我也把它归为「完成这个东西」的途中所需要用到的知识！而不是我要把这个前置知识学完了才去完成这个项目，如项目要用的 `TypeScript`，我是否要先把 `TypeScript` 的各种知识 都得好好认识一番呢？ -> 不需要，有了基本的认识，就可以开干了，就像是方方他为啥用两个下午通读完 Vue 官方文档之后，就去做 Vue 项目了呢？（当然，方方的基础扎实，这没话说哈！）
